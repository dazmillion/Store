        ...
        <ul class="sidebar-nav mobile-sidebar">
          ...
          <li class="msocial">
            <div class="social-links">
              <div class="social-text">Let's be social...</div>
              <div  class="social-images">
                <div class="social-image"><a title="Visit our Facebook page" href="#" target="blank"><img src="<?php bloginfo('template_directory'); ?>/images/fb.png" alt="Facebook"></a></div>
                <div class="social-image"><a title="Follow us on Instagram" href="#" target="blank"><img src="<?php bloginfo('template_directory'); ?>/images/inst.png" alt="Instagram"></a></div>
              </div>
            </div>
          </li>
        </ul>
		  ...
		  <div id="page-content-wrapper">
  			<div class="phone-header">
  				<div class="header-mobile">
  					<div class="header-mobile-toggle">
  						<div class="header-mobile-toggle_link">
              ...
              <div class="header-mobile-search_link">
                <i class="fa fa-search" aria-hidden="true"></i>
  					...
  					<div class="mobile-mini-cart">
  							<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e( 'View your shopping cart' ); ?>">
  									<i class="nav-icon nav-sprite"><span class="cart-count"><?php echo sprintf ( WC()->cart->get_cart_contents_count() ); ?></span></i>
  							</a>
  					</div>
  				</div>
  			</div>
